            ...
            <div class="row">
                <div class="container-service text-center">
                    ...
                    <div class="content-service">
                        <h3 class="text-start">Thông tin dịch vụ:</h3>
                        <div class="service-food text-start">
                            <h3>Dịch vụ đưa đón:</h3>
                            <ul>
                                <li>Xe giường nằm 45 chỗ đưa đón tận nơi</li>
                                <li>Porter khuân vác đồ đoàn và đồ cá nhân của bạn.</li>
                                <li>Bạn có thể đi xe riêng và chúng tôi sẽ hoàn tiền lại cho bạn 150/người/lượt</li>
                            </ul>
                            <img src="" alt="">
                        </div>
                        <div class="service-food text-start">
                            ...
                            <ul>
                                <li>Tất cả các bữa ăn trong 2 ngày,gồm cả bữa lẩu liên hoan ngày cuối cùng</li>
                                <li>Thực phẩm cung cấp đủ chất dinh dưỡng và năng lượng cho thành viên leo núi</li>
                                <li>Nước uống: Chai 800ml phát từ đầu (Nước được bổ sung trên đường trekking).</li>
                            </ul>
                            <img src="" alt="">
                        </div>
                        <div class="service-food text-start">
