        ...
        <div class="main">
            ...
            <?php foreach ($list as $value) : ?>
                ...
                <?php foreach ($arr as $value) : ?>
                    <div class="box-img">
                <img src="<?php echo $value->AvatarTour?>" alt="" style="width: 100%;height:100vh">
                <div class="title-tour">
                    <h2><?php echo $value->TourName?></h2>
                </div>
            </div>
            <div class="container">
                <div class="row">
                        ...
                        <div style="padding-bottom: 0px ;">
                            <ul class="d-flex justify-content-around">
                                ...
                                <li class="d-flex align-items-center" style="margin-bottom: 30px ;">
                                    ...
                                    <div class="gdlr-core-icon-list-content-wrap">
                                        <span class="gdlr-core-icon-list-content" style="font-size: 15px ;">Giá tour:<?php echo $value->TourPrice?></span>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center" style="margin-bottom: 30px ;">
                                    <span class="gdlr-core-icon-list-icon-wrap gdlr-core-left" style="margin-top: 0px ;margin-right: 18px ;">
                                    ...
                                    <div class="gdlr-core-icon-list-content-wrap">
                                        <span class="gdlr-core-icon-list-content" style="font-size: 15px ;">Location:<?php echo $value->Location?></span>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center" style="margin-bottom: 30px ;">
                                    <span class="gdlr-core-icon-list-icon-wrap gdlr-core-left" style="margin-top: 0px ;margin-right: 18px ;">
                                    ...
                                    <div class="gdlr-core-icon-list-content-wrap">
                                        <span class="gdlr-core-icon-list-content" style="font-size: 15px ;">Status:<?php echo $value->Status?></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="tour-description">
                            <p>Sa Pa – thị trấn trong sương, nơi giao thoa giữa đất và trời, nơi ngọn núi Fansipan huyền thoại nghiêng bóng xuống dòng suối trắng của thung lũng Mường Hoa xinh đẹp. Cùng khám phá Đồi Bò với viewpoint đẹp nhất Sa Pa, tham gia vào bữa tiệc camping thú vị trên núi cao.

                                Hãy sẵn sàng cho những bức ảnh “triệu like” ngay thôi!</p>
                        </div>
                        <div class="form-booktour">
                            <!-- Form-->
                            <form>
                                <div class="row gy-40">
                                    <div class="col-12 col-md-6 mb-5"><input class="form-control form-contact" type="text" placeholder="Your Name *"></div>
                                    <div class="col-12 col-md-6 mb-5"><input class="form-control form-contact" type="email" placeholder="Your Email *"></div>
                                    <div class="col-12 col-md-6 mb-5"><input class="form-control form-contact" type="tel" placeholder="Your Phone *"></div>
                                    <div class="col-12 col-md-6 mb-5"><input class="form-control form-contact" type="text" placeholder="Address"></div>
                                    ...
                                    <div class="col-12 col-lg-3 text-end text-lg-start">
                                        <!-- Button--><button class="btn btn-danger">Booktour</button>
                                    </div>
                                </div>
                            </form>
                        </div>
